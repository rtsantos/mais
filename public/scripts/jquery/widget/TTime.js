...
(function($) {
	 ...
	 */
        _create: function(){
            ...
            this.divTime = $('<div></div>')
            .attr('id','divTTime'+this.element.attr('id'))
            .addClass('divTTime')
            ...
            this.element.addClass(self.options.inputCSS)            
                        .keydown(function (e){return self._keyValidade(e);})
                        .keyup(function (e){                            
            ...
            if(self.options.showButtonSearch){
                ...
                .css('top','0')
                .css('height', (self.element.height() + 2) + 'px')
                /*.css('right','-2px')*/
                .click(function(){
                    self.openClose();
                })
                ...
                .addClass('ui-button-icon-primary ui-icon ui-icon-clock')
