                    ...
                    if (validator.form()) {
                        if (validator.pendingRequest) {
                            ...
                            if (validator.settings.beforeSubmit) {
                                if (validator.settings.beforeSubmit() == false) {
                                    return false;
                                }
                            }
                        }
    ...
    $.extend($.validator, {
        ...
        methods: {
            ...
            required: function (value, element, param) {
                ...
                var selector = "#group-" + name + " #table-" + name + "-multiple tr .ac-multi";
                selector = replaceAll('[]', '\\[\\]', selector);
                var multiValue = $(selector).size();
                return $.trim(value).length > 0 || multiValue;
            },
