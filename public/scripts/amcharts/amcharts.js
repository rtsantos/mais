...
AmCharts.formatDate=function(a,b){
    ...
    var m=String(c).substr(2,2),q=d+1;
    9>d&&(q="0"+q);
    var n=e;
    10>e&&(n="0"+e);
    var r="0"+f;
...
AmCharts.Cuboid=AmCharts.Class({
    ...
    draw:function(){
        ...
        this.bwidth,k=this.bcolor,l=this.balpha,m=this.gradientRotation,q=this.cornerRadius,n=g,r=g;
        ...
        if(0<e||0<f)v=r,r=AmCharts.adjustLuminosity(n,-0.2),r=AmCharts.adjustLuminosity(n,-0.2),p=AmCharts.polygon(b,[0,e,c+e,c,0],[0,f,f,0,0],r,h,0,0,0,m),0<l&&(y=AmCharts.line(b,[0,e,c+e],[0,f,f],k,l,j)),u=AmCharts.polygon(b,[0,0,c,c,0],[0,d,d,0,0],r,h,0,0,0,0,m),u.translate(e,f),0<l&&(t=AmCharts.line(b,[e,e],[f,f+d],k,1,j)),s=AmCharts.polygon(b,
            [0,0,e,e,0],[0,d,d+f,f,0],r,h,0,0,0,m),w=AmCharts.polygon(b,[c,c,c+e,c+e,c],[0,d,d+f,f,0],r,h,0,0,0,m),0<l&&(x=AmCharts.line(b,[c,c+e,c+e,c],[0,f,d+f,d],k,l,j)),r=AmCharts.adjustLuminosity(v,0.2),v=AmCharts.polygon(b,[0,e,c+e,c,0],[d,d+f,d+f,d,d],r,h,0,0,0,m),0<l&&(z=AmCharts.line(b,[0,e,c+e],[d,d+f,d+f],k,l,j));
        1>Math.abs(d)&&(d=0);
        1>Math.abs(c)&&(c=0);
...
AmCharts.AmLegend=AmCharts.Class({
    ...
    arrangeEntries:function(){
        ...
        e=this.marginBottom,f=this.horizontalGap,g=this.div,h=this.divWidth,j=this.maxColumns,k=this.verticalGap,l=this.spacing,m=h-c-b,q=0,n=0,r=this.container,p=r.set();
        this.set=p;
        r=r.set();
        p.push(r);
    ...
    createEntry:function(a){
        if(!1!==a.visibleInLegend){
            ...
            var d=AmCharts.massReplace(this.labelText,{
                "[[title]]":a.title
                }),j=this.fontSize,k=this.markerSize;
            if(f&&k<=j){
                var l=0;
    ...
    draw:function(){
        ...
        if(!isNaN(a)){
            ...
            if(this.show){
                ...
                var r=this.horizontalPadding,m=this.verticalPadding,p=this.pointerWidth,u=this.pointerOrientation,t=this.cornerRadius,
                ...
                0<t||0===p?(n=AmCharts.rect(e,s,l,q,this.fillAlpha,this.borderThickness,n,this.borderAlpha,this.cornerRadius),this.showBullet&&(e=AmCharts.circle(e,this.bulletSize,q,this.fillAlpha),e.translate(a,b),this.pointer=e)):(k=[],t=[],"H"!=u?(g=a-v,g>s-p&&(g=s-p),g<p&&(g=p),k=[0,g-p,a-v,g+p,s,s,0,0],t=b<h+l+10&&"down"!=u?[0,0,b-c,0,0,l,l,0]:[l,l,b-c,l,l,0,0,l]):(h=b-c,h>l-p&&(h=l-p),h<p&&(h=p),t=[0,h-p,b-c,h+p,l,l,0,0],k=a<g+(j-g)/2?[0,0,v<a?0:a-v,0,0,s,s,0]:[s,s,v+s>a?s:a-
                    v,s,s,0,0,s]),n=AmCharts.polygon(e,k,t,q,this.fillAlpha,this.borderThickness,n,this.borderAlpha));
                f.push(n);
                n.toFront();
                x&&x.toFront();
                d.toFront();
...
parseSerialData:function(){
    ...
    if(e){
        ...
        for(q=0;q<e.length;q++){
            ...
            j&&(n.forceShow=r[j]);
            m[r[d]]=n;
            f&&(b=h.categoryFunction?h.categoryFunction(b,r,h):isNaN(b)?new Date(b.getFullYear(),b.getMonth(),b.getDate(),b.getHours(),b.getMinutes(),b.getSeconds(),b.getMilliseconds()):new Date(b),b=AmCharts.resetDateToMin(b,k,l),n.category=b,n.time=b.getTime());
...
AmCharts.TrendLine=AmCharts.Class({
    ...
    draw:function(){
        var a=this;
        a.destroy();
        var b=a.chart,c=b.container,d,e,f,g,h=a.categoryAxis,j=a.initialDate,k=a.initialCategory,l=a.finalDate,m=a.finalCategory,q=a.valueAxis,n=a.valueAxisX,r=a.initialXValue,p=a.finalXValue,u=a.initialValue,t=a.finalValue,s=q.recalculateToPercents;
    ...
    draw:function(){
        ...
        if(this.logarithmic&&(0>=this.getMin(0,this.data.length-1)||0>=this.minimum))this.fire("logarithmicAxisFailed",{
            ...
            if(!isNaN(this.min)&&!isNaN(this.max)&&this.foundGraphs&&Infinity!=this.min&&-Infinity!=
                this.max){
                var k=this.labelFrequency,l=this.showFirstLabel,m=this.showLastLabel,q=1,n=0,r=Math.round((this.max-this.min)/this.step)+1,p;
                ...
                for(d=n;d<r;d+=q)if(n=this.step*d+this.min,n=AmCharts.roundTo(n,this.maxDecCount+1),!(this.integersOnly&&Math.round(n)!=n)&&(isNaN(u)||Number(AmCharts.toFixed(n,u))==n)){
                    ...
                    if(n==this.baseValue&&"radar"!=j){
                        var N,H,x=this.viW,v=this.viH,n=this.viX;
                        s=this.viY;
...
stackGraphs:function(a){
    ...
    "100% stacked"==b&&(b="100%");
    this.stackType=b;
    var c=[],d=[],e=[],f=[],g,h=this.chart.graphs,j,k,l,m,q=this.baseValue,n=!1;
    if("line"==a||
        "step"==a||"smoothedLine"==a)n=!0;
    if(n&&("regular"==b||"100%"==b))for(m=0;m<h.length;m++)l=h[m],l.hidden||(k=l.type,l.chart==this.chart&&(l.valueAxis==this&&a==k&&l.stackable)&&(j&&(l.stackGraph=j),j=l));
    for(j=this.start;j<=this.end;j++){
        var r=0;
        for(m=0;m<h.length;m++)if(l=h[m],!l.hidden&&(k=l.type,l.chart==this.chart&&(l.valueAxis==this&&a==k&&l.stackable)&&(k=this.data[j].axes[this.id].graphs[l.id],g=k.values.value,!isNaN(g)))){
        ...
        for(j=this.start;j<=this.end;j++)for(m=0;m<h.length;m++)l=h[m],l.hidden||(k=l.type,l.chart==this.chart&&(l.valueAxis==this&&a==k&&l.stackable)&&(k=this.data[j].axes[this.id].graphs[l.id],g=k.values.value,isNaN(g)||(c=100*(g/f[j]),k.values.percents=c,k.values.total=f[j],"100%"==b&&(isNaN(d[j])&&(d[j]=0),isNaN(e[j])&&(e[j]=0),0>c?(k.values.close=AmCharts.fitToBounds(c+d[j],-100,100),k.values.open=d[j],d[j]=k.values.close):(k.values.close=
    ...
    for(d=a;d<=b;d++){
        ...
        for(f in e)if(e.hasOwnProperty(f)){
            ...
            if(g.includeInMinMax&&(!g.hidden||this.includeHidden)){
                ...
                var h;
                if(this.minMaxField)h=g[this.minMaxField],h<c&&(c=h);else for(var j in g)g.hasOwnProperty(j)&&("percents"!=j&&"total"!=j)&&(h=g[j],h<c&&(c=h))
                    }
                }
        }
        return c
...
AmCharts.CategoryAxis=AmCharts.Class({
    ...
    draw:function(){
        ...
        if(AmCharts.ifArray(a)){
            ...
            if(this.parseDates&&this.equalSpacing){
                ...
                for(this.previousPos=0;b<n;b++)if(r=this.data[b].time,this.checkPeriodChange(e,m,r,l)){
    ...
    this.startTime)*this.stepWidth+this.cellWidth/2):this.getCoordinate(b-f),h.x[this.id]=j;h=this.guides.length;
...
AmCharts.RecAxis=AmCharts.Class({
    construct:function(a){
        var b=a.chart,c=a.axisThickness,d=a.axisColor,e=a.axisAlpha,f=a.offset,g=a.dx,h=a.dy,j=a.viX,k=a.viY,l=a.viH,m=a.viW,q=b.container;
...
AmCharts.RecItem=AmCharts.Class({
    construct:function(a,b,c,d,e,f,g,h,j){
        ...
        this.set=n;
        var r=a.axisThickness,p=a.axisColor,u=a.axisAlpha,t=a.tickLength,s=a.gridAlpha,w=a.gridThickness,x=a.gridColor,v=a.dashLength,z=a.fillColor,y=a.fillAlpha,F=a.labelsEnabled,G=a.labelRotation,N=a.counter,H=a.inside,
        V=a.dx,T=a.dy,ra=a.orientation,Q=a.position,S=a.previousCoord,O=a.viH,ka=a.viW,ca=a.offset,da,ea;
        g?(F=!0,isNaN(g.tickLength)||(t=g.tickLength),void 0!=g.lineColor&&(x=g.lineColor),isNaN(g.lineAlpha)||(s=g.lineAlpha),isNaN(g.dashLength)||(v=g.dashLength),isNaN(g.lineThickness)||(w=g.lineThickness),!0===g.inside&&(H=!0),isNaN(g.labelRotation)||(G=g.labelRotation),isNaN(g.fontSize)||(l=g.fontSize),g.position&&(Q=g.position)):""===c&&(t=0);
        ea="start";
        e&&(ea="middle");
        var W=G*Math.PI/180,U,E=0,D=0,Z=0,
        A=U=0;
        "V"==ra&&(G=0);
        var X;
        ...
        if("H"==ra){
            ...
            D+=l/2;
            "right"==Q?(E+=V+ka+ca,D+=T,H?(E-=t+4,f||(D-=l/2+3)):(E+=t+4+r,D-=2)):
            H?(E+=t+4-ca,f||(D-=l/2+3),g&&(E+=V,D+=T)):(E+=-t-r-4-2-ca,D-=2);
...
AmCharts.RadAxis=AmCharts.Class({
    construct:function(a){
        ...
        if(b){
            ...
            var q=a.length,n;
            for(n=0;n<q;n++){
                var r=180-360/q*n,p=f+this.axisWidth*Math.sin(r/180*Math.PI),u=g+this.axisWidth*Math.cos(r/
                    180*Math.PI);
                0<e&&(p=AmCharts.line(b.container,[f,p],[g,u],d,e,c),this.set.push(p));
                if(j){
                    var t="start",p=f+(this.axisWidth+h)*Math.sin(r/180*Math.PI),u=g+(this.axisWidth+h)*Math.cos(r/180*Math.PI);
...
AmCharts.RadItem=AmCharts.Class({
    construct:function(a,b,c,d,e,f,g){
        ...
        this.set=d=l.set();
        var m=a.axisColor,q=a.axisAlpha,n=a.tickLength,r=a.gridAlpha,p=a.gridThickness,u=a.gridColor,t=a.dashLength,s=a.fillColor,w=a.fillAlpha,x=a.labelsEnabled;
        e=a.counter;
        var v=a.inside,z=a.gridType,y;
        b-=a.height;
        var F;
        f=a.x;
        var G=a.y;
...
createSerialGraph:function(){
    ...
    var U=this.chart.columnSpacing,E=V.cellWidth,D=(E*h-q)/q;
    U>D&&(U=D);
    var Z,A,X,Va=k+1,Wa=j+1,Oa=0,Xa=0,Ya,Za,Pa,Qa,Bb=this.fillColors,Ea=this.negativeFillColors,xa=this.negativeLineColor,Fa=this.fillAlphas,Ga=this.negativeFillAlphas;
    ...
    if(!H&&("line"==g||"smoothedLine"==g||"step"==g))if(1==d.length&&("step"!=g&&"none"==this.bullet)&&(this.bullet="round",this.resetBullet=!0),Ea||void 0!=xa){
        var Ba=ra;
        Ba>f.max&&(Ba=f.max);
        Ba<f.min&&(Ba=f.min);
    ...
    if("line"==g||"step"==g||"smoothedLine"==g){
        if(0<G)for(L=G-1;-1<L;L--)if(Z=d[L],A=Z.axes[f.id].graphs[b],X=A.values.value){
            G=L;
            break
        }
        if(N<
            d.length-1)for(L=N+1;L<d.length;L++)if(Z=d[L],A=Z.axes[f.id].graphs[b],X=A.values.value){
            N=L;
            break
        }
        }
        N<d.length-1&&N++;
var fa=[],ga=[],Ha=!1;
if("line"==g||"step"==g||"smoothedLine"==g)if(this.stackable&&"regular"==y||"100%"==y||this.fillToGraph)Ha=!0;
    for(L=G;L<=N;L++){
    Z=d[L];
    A=Z.axes[f.id].graphs[b];
    A.index=L;
    var J,K,I,$,ma=NaN,C=NaN,B=NaN,P=NaN,M=NaN,Ia=NaN,ya=NaN,Ja=NaN,za=NaN,Y=NaN,ba=NaN,na=NaN,oa=NaN,R=NaN,$a=NaN,ab=NaN,ha=NaN,ia=void 0,ua=Bb,Ka=Fa,la=ka,ja,pa;
    ...
    if(qa){
        ...
        if(!H)switch(this.showBalloonAt){
            ...
            case "low":
                ...
                var ma=Z.x[V.id],va=Math.floor(E/
            2),La=va;
        ...
        switch(g){
            ...
            case "column":
                ...
                if(!(R<ob&&ha<ob||R>pb&&ha>pb))if(m){
                    ...
                    if(K<k&&0<I&&(ia=new AmCharts.Cuboid(e,$,I,v-a.d3x,z-a.d3y,ua,Ka,S,ja,O,W,n,m),"bottom"!=F))if(F=f.reversed?"left":"right",0>R)F=f.reversed?"right":"left";
                    ...
                    $=AmCharts.fitToBounds($,
                        -K+z*Q,k-K);
                    if(J<j+Q*v&&0<I)if(ia=new AmCharts.Cuboid(e,I,$,v-a.d3x,z-a.d3y,ua,Ka,S,ja,this.lineAlpha,W,n,m),0>R&&"middle"!=F)F="bottom";
        ...
        case "candlestick":
            ...
            var ia=new AmCharts.Cuboid(e,I,$,v,z,ua,Ka,S,ja,O,W,n,m),eb,fb;
    ...
    case "ohlc":
        ...
        if(m){
            ...
            var lb=C-h/2,lb=AmCharts.fitToBounds(lb,0,j),rb=AmCharts.fitToBounds(C,0,j),mb=C+h/2,mb=AmCharts.fitToBounds(mb,0,j);
    ...
    if(this.end-
        ...
        if(tb){
            var aa=this.createLabel(A,0,0,tb),wa=0,Aa=0,ub=aa.getBBox(),Ta=ub.width,Ua=ub.height;
            switch(F){
                case "left":
                    wa=-(Ta/2+Ca/2+3);
                    break;
                ...
                case "middle":
                    ...
                    if(aa){
                if(!isNaN(ba)&&!isNaN(Y))if(Y+=wa,ba+=Aa,aa.translate(Y,ba),m){
        ...
        if(wb){
            ...
            var xb=Da.getBBox(),yb=xb.width,zb=xb.height,Ma,Na,Ab=f.totals[L];
            Ab&&Ab.remove();
...
drawLineGraph:function(a,b,c,d){
    ...
    if(1<a.length){
        ...
        f.push(j);
        f.push(h);
        var k=e.lineAlpha,l=e.lineThickness,m=e.dashLength,f=e.fillAlphas,q=e.lineColor,n=e.fillColors,r=e.negativeLineColor,p=e.negativeFillColors,u=e.negativeFillAlphas,t=e.baseCoord;
        ...
        if(0<f||0<u)if(k=a.join(";").split(";"),l=b.join(";").split(";"),"serial"==e.chartType&&(0<c.length?(c.reverse(),d.reverse(),k=a.concat(c),l=b.concat(d)):e.rotate?(l.push(l[l.length-1]),k.push(t),l.push(l[0]),k.push(t),l.push(l[0]),k.push(k[0])):(k.push(k[k.length-1]),l.push(t),k.push(k[0]),l.push(t),k.push(a[0]),l.push(l[0]))),0<f&&(a=AmCharts.polygon(g,
...
drawSmoothedGraph:function(a,b,c,d){
    if(1<a.length){
        ...
        e=this.dashLength,l=this.fillAlphas,m=this.fillColors,q=this.negativeLineColor,n=this.negativeFillColors,r=this.negativeFillAlphas,p=this.baseCoord,u=new AmCharts.Bezier(f,a,b,this.lineColor,j,k,m,0,e);
        g.push(u.path);
...
createBullet:function(a,b,c){
    ...
    if("none"!=this.bullet||a.bullet){
        ...
        m=j,q=this.bulletAlpha,j=a.alpha;
        isNaN(j)||(q=j);
        j=0;
        switch(e){
            case "round":
...
AmCharts.ChartCursor=AmCharts.Class({
    ...
    createCursor:function(){
        ...
        d=c.position,e=c.inside,f=c.axisThickness,g=this.categoryBalloon,h,j,k=a.dx,l=a.dy,m=this.x,q=this.y,n=this.width,r=this.height,a=a.rotate,p=c.tickLength;
        g.pointerWidth=p;
...
updateCursor:function(a,b){
    ...
    if(this.enabled){
        void 0===b&&(b=!0);
        this.index=a;
        var f=c.categoryAxis,g=c.dx,h=c.dy,j=this.x,k=this.y,l=this.width,m=this.height,q=this.data[a];
        if(q){
            var n=q.x[f.id],r=c.rotate,p=f.inside,u=this.stepWidth,
            t=this.categoryBalloon,s=this.firstTime,w=this.lastTime,x=this.cursorPosition,v=f.position,z=this.zooming,y=this.panning,F=c.graphs,G=f.axisThickness;
            if(c.mouseIsOver||z||y||this.forceShow)if(this.forceShow=!1,y){
                var g=this.panClickPos,c=this.panClickEndTime,z=this.panClickStartTime,N=this.panClickEnd,j=this.panClickStart,d=(r?g-e:g-d)/u;
            ...
            if(F&&this.valueBalloonsEnabled&&s&&c.balloon.enabled){
                ...
                if(this.oneBalloonOnly){
                    ...
                    for(f=0;f<F.length;f++)if(u=F[f],!(this.oneBalloonOnly&&u!=N)&&(u.showBalloon&&!u.hidden&&u.balloonText)&&(t=q.axes[u.valueAxis.id].graphs[u.id],w=t.y,!isNaN(w))){
                    n=t.x;
                    p=!0;
                    if(r){
                        if(h=w,0>n||n>m)p=!1
...
AmCharts.SimpleChartScrollbar=AmCharts.Class({
    ...
    updateScrollbar:function(){
        ...
        c=h.x+e;
        d=h.y+f;
        var j=h.width,h=h.height,k=this.rotate,l=this.chart,m=this.width,q=this.height,n=l.mouseX,r=l.mouseY;
        a=this.initialMouse;
...
AmCharts.ChartScrollbar=AmCharts.Class({
    ...
    draw:function(){
        ...
        if(k=a.graph){
            ...
            l.push(m.set);
            e?m.y=g:m.x=f;
            var f=Infinity,g=-Infinity,n;
            for(n=0;n<c.length;n++){
                var r=c[n].axes[q.id].graphs[k.id].values,p;
...
AmCharts.wedge=function(a,b,c,d,e,f,g,h,j,k,l){
    ...
    g=m(g);
    h=m(h);
    var q=m(g/f*h),n=AmCharts.VML,r=-359.5-f/100;
    -359.95>r&&(r=-359.95);
    e<=r&&(e=r);
    var p=1/180*Math.PI,r=b+Math.cos(d*p)*h,u=c+Math.sin(-d*p)*q,t=b+Math.cos(d*p)*f,s=c+Math.sin(-d*p)*g,w=b+Math.cos((d+e)*p)*f,x=c+Math.sin((-d-e)*p)*g,v=b+Math.cos((d+e)*p)*h,p=c+Math.sin((-d-e)*p)*q,z={
    ...
    if(AmCharts.ifArray(b)){
        if(0<a.realWidth&&0<a.realHeight){
            ...
            for(l=0;l<b.length;l++)if(e=b[l],!0!==e.hidden&&0<e.percents){
                var j=360*-e.percents/100,p=Math.cos((f+j/2)/180*Math.PI),u=Math.sin((-f-j/2)/180*Math.PI)*(k/n),h={
                    fill:e.color,
...
checkOverlapping:function(a,b,c,d,e){
    ...
    if(k){
        if(!0===d)for(g=a+1;g<j;g++)(f=this.checkOverlappingReal(b,h[g],c))&&(g=j);else for(g=a-1;0<=g;g--)(f=
...
svgPathToVml:function(a){
    ...
    for(e=0;e<b.length;e++){
        ...
        "Z"==g&&(a+=" x e");
        if("Q"==g){
            var k=c.length,l=c[k-1],m=h[0],q=h[1],j=h[2],n=h[3];
            c=d(c[k-2]/3+2/3*m);
            l=d(l/3+2/3*q);
            m=d(2/3*m+j/3);
            q=d(2/3*q+n/3);
