<?php
    /**
    * Classe de visão da tabela pf_job
    */
    class Profile_DataView_Job_Crud_MapperView extends Profile_Model_Job_Mapper implements ZendT_Db_View
    {
        ...
        protected function _getSettingsDefault(){
           $profile = array();
           $profile['order'] = array('id','id_profile_object_view','descricao','dh_ini_exec','dh_ult_exec','tipo','frequencia','dt_fim_exec');
           $profile['width'] = array('id'=>100,'id_profile_object_view'=>120,'descricao'=>524,'dh_ini_exec'=>150,'dh_ult_exec'=>150,'tipo'=>150,'frequencia'=>150,'dt_fim_exec'=>100);
           $profile['align'] = array('id'=>'left','id_profile_object_view'=>'left','descricao'=>'left','dh_ini_exec'=>'center','dh_ult_exec'=>'center','tipo'=>'center','frequencia'=>'right','dt_fim_exec'=>'center');
