 ...
 */
class Cms_Model_PrivCateg_Crud_Mapper extends ZendT_Db_Mapper
{
    protected $_required = array('id','id_categoria','tipo','env_email');
    protected $_model = 'Cms_Model_PrivCateg_Table';
    /**
     *
     * @var Cms_Model_PrivCateg_Mapper
     */
     ...
     *
     * @param string $value
     * @return Cms_Model_PrivCateg_Crud_Mapper
     */
