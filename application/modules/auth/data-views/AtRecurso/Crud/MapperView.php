<?php
    ...
    */
    class Auth_DataView_AtRecurso_Crud_MapperView extends Auth_Model_AtRecurso_Mapper implements ZendT_Db_View
    {
        ...
        protected function _loadColumns(){
            $this->_columns = new ZendT_Db_Column_View('Auth_DataView_AtRecurso_MapperView',$this->_getSettingsDefault());
