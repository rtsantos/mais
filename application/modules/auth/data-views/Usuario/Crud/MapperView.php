<?php
    ...
    */
    class Auth_DataView_Usuario_Crud_MapperView extends Auth_Model_Usuario_Mapper implements ZendT_Db_View
    {
        ...
        protected function _getSettingsDefault(){
           $profile = array();
           $profile['order'] = array('id','idtipousuario','descricao_tipousuario','login','senha','nome','validadesenha','trocasenha','dhtrocasenha','expiracaosenha','status','nerroslogin','usuarioadmin','cgccpf','endereco','telefone','email','usuario','datahora','fax','idpessoal','chapa','codccustodef','codeof','idempresa','sigla_empresa','nome_pessoa','idempresadef','sigla_empresadef','nome_pessoadef','idfilial','sigla_filial','idusuarioresp','login_usuarioresp','nome_usuarioresp','id_papel','nome_papel','solic_info_adic','observacao','empresa','dh_ult_logon','ntry','avatar');
           $profile['width'] = array('id'=>192.5,'idtipousuario'=>120,'descricao_tipousuario'=>200,'login'=>200,'senha'=>100,'nome'=>200,'validadesenha'=>100,'trocasenha'=>150,'dhtrocasenha'=>150,'expiracaosenha'=>150,'status'=>150,'nerroslogin'=>150,'usuarioadmin'=>100,'cgccpf'=>25,'endereco'=>200,'telefone'=>25,'email'=>200,'usuario'=>25,'datahora'=>150,'fax'=>25,'idpessoal'=>150,'chapa'=>15,'codccustodef'=>15,'codeof'=>35,'idempresa'=>120,'sigla_empresa'=>200,'nome_pessoa'=>200,'idempresadef'=>120,'sigla_empresadef'=>200,'nome_pessoadef'=>200,'idfilial'=>120,'sigla_filial'=>200,'idusuarioresp'=>120,'login_usuarioresp'=>200,'nome_usuarioresp'=>200,'id_papel'=>120,'nome_papel'=>200,'solic_info_adic'=>150,'observacao'=>200,'empresa'=>200,'dh_ult_logon'=>150,'ntry'=>150,'avatar'=>150);
           $profile['align'] = array('id'=>'left','idtipousuario'=>'left','descricao_tipousuario'=>'left','login'=>'left','senha'=>'left','nome'=>'left','validadesenha'=>'center','trocasenha'=>'center','dhtrocasenha'=>'center','expiracaosenha'=>'right','status'=>'center','nerroslogin'=>'right','usuarioadmin'=>'left','cgccpf'=>'left','endereco'=>'left','telefone'=>'left','email'=>'left','usuario'=>'left','datahora'=>'center','fax'=>'left','idpessoal'=>'right','chapa'=>'left','codccustodef'=>'left','codeof'=>'left','idempresa'=>'left','sigla_empresa'=>'left','nome_pessoa'=>'left','idempresadef'=>'left','sigla_empresadef'=>'left','nome_pessoadef'=>'left','idfilial'=>'left','sigla_filial'=>'left','idusuarioresp'=>'left','login_usuarioresp'=>'left','nome_usuarioresp'=>'left','id_papel'=>'left','nome_papel'=>'left','solic_info_adic'=>'center','observacao'=>'left','empresa'=>'left','dh_ult_logon'=>'center','ntry'=>'right','avatar'=>'right');
           $profile['hidden'] = array('idtipousuario','idempresa','idempresadef','idfilial','idusuarioresp','id_papel');
        ...
        protected function _loadColumns(){
            ...
            $this->_columns->add('idpessoal', 'usuario', 'idpessoal', $this->getModel()->getMapperName(), ZendT_Lib::translate('usuario.idpessoal'),'Numeric','=');
            ...
            $this->_columns->add('sigla_empresa', 'empresa', 'sigla', $this->_getEmpresa()->getModel()->getMapperName(), ZendT_Lib::translate('usuario.idempresa.empresa.sigla'),null,'?%');
            $this->_columns->add('nome_pessoa', 'pessoa', 'nome', $this->_getPessoa()->getModel()->getMapperName(), ZendT_Lib::translate('usuario.idempresa.empresa.nome_pessoa'),null,'?%');
            ...
            $this->_columns->add('empresa', 'usuario', 'empresa', $this->getModel()->getMapperName(), ZendT_Lib::translate('usuario.empresa'),'String','%?%');
            $this->_columns->add('dh_ult_logon', 'usuario', 'dh_ult_logon', $this->getModel()->getMapperName(), ZendT_Lib::translate('usuario.dh_ult_logon'),'DateTime','=');
            $this->_columns->add('ntry', 'usuario', 'ntry', $this->getModel()->getMapperName(), ZendT_Lib::translate('usuario.ntry'),'Numeric','=');
        ...
        protected function _getSqlBase() {
            $sql = $this->getModel()->getTableName().' '.$this->getModel()->getName() ." 
                    ...
                    LEFT  JOIN ".$this->_getPessoa()->getModel()->getTableName()." pessoa ON ( idempresa.id_pessoa = pessoa.id ) 
                    LEFT  JOIN ".$this->_getEmpresa()->getModel()->getTableName()." empresadef ON ( usuario.idempresadef = empresadef.id ) 
                    LEFT  JOIN ".$this->_getPessoa()->getModel()->getTableName()." pessoadef ON ( idempresadef.id_pessoa = pessoadef.id ) 
