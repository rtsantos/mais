<?php
/**
 * Classe de mapeamento dos pontos de entrada da tabela at_aplicacao
 */
class Auth_Form_Aplicacao_Crud_Elements
{
    ...
    public function getId(){
        ...
        $element->setLabel($this->_translate->_('at_aplicacao.id') . ':');
    ...
    public function getSigla(){
        ...
        $element->setLabel($this->_translate->_('at_aplicacao.sigla') . ':');
    ...
    public function getNome(){
        ...
        $element->setLabel($this->_translate->_('at_aplicacao.nome') . ':');
    ...
    public function getStatus(){
        ...
        $element->setLabel($this->_translate->_('at_aplicacao.status') . ':');
    ...
    public function getObservacao(){
        ...
        $element->setLabel($this->_translate->_('at_aplicacao.observacao') . ':');
    ...
    public function getIcone(){
        ...
        $element->setLabel($this->_translate->_('at_aplicacao.icone') . ':');
    ...
    public function getUrl(){
        ...
        $element->setLabel($this->_translate->_('at_aplicacao.url') . ':');
    ...
    public function getDhInc(){
        ...
        $element->setLabel($this->_translate->_('at_aplicacao.dh_inc') . ':');
