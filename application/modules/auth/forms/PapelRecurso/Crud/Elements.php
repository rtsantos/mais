<?php
/**
 * Classe de mapeamento dos pontos de entrada da tabela papel_recurso
 */
class Auth_Form_PapelRecurso_Crud_Elements
{
     ...
     * @return Auth_Form_PapelRecurso_Elements
     */
    ...
    public function getId(){
        ...
        $element->setLabel($this->_translate->_('papel_recurso.id') . ':');
    ...
    public function getIdPapel(){
        ...
        $element->setLabel($this->_translate->_('papel_recurso.id_papel') . ':');
    ...
    public function getIdRecurso(){
        ...
        $element->setLabel($this->_translate->_('papel_recurso.id_recurso') . ':');
        $element->setIdField('id');
        $element->setIdAttribs(array());
        $element->setSearchField('hierarquia');
    ...
    public function getAcesso(){
        ...
        $element->setLabel($this->_translate->_('papel_recurso.acesso') . ':');
