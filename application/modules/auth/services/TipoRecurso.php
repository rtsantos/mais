<?php
     ...
     */
    class TipoRecurso_Result extends ZendT_Service_Result {
        
    }
    /**
     * Resultado para listar os registros do modelo
     */
    class TipoRecurso_Result_Rows extends ZendT_Service_Result_Rows{
        /**
         * Registros do modelo TipoRecurso
         * @var TipoRecurso_Columns[]
         */
        public $rows;
    }
    /**
     ...
     */
    class TipoRecurso_Result_Row extends ZendT_Service_Result_Row{
        /**
         * Registros do modelo TipoRecurso
         * @var TipoRecurso_Columns
         */
    ...
    /**
     * Classe de serviço do modelo TipoRecurso
     *
     * @package ZendT
     * @subpackage Service
     */
    class Auth_Service_TipoRecurso extends ZendT_Service_Crud{
        /**
         * Construtor do serviço para levantar o modelo
         */
        public function __construct(){
            $this->_model = new Auth_Model_TipoRecurso_Table();
        }
        /**
         * Insere um registro no modelo TipoRecurso
         *
         * @param string $token
         * @param TipoRecurso_Columns $data 
         * @return TipoRecurso_Result
         */
        public function insert($token,$data){  
            $_result = new TipoRecurso_Result();
        ...
        /**
         * Atualiza um dado do modelo TipoRecurso
        ...
        /**
         * Apaga um registro do modelo TipoRecurso
         * Esse método é possível usar o parâmetro $data 
         * para fazer o Where, preenchendo a chave primária
         * Passando o parâmetro $where vazio
         *
        ...
        /**
         * Busca as linhas e colunas do modelo TipoRecurso
         *
         * @param string $token
         * @param ZendT_Service_Where[] $where 
         * @param string $whereGroupOp 
         * @return TipoRecurso_Result_Rows
         */
        public function fetchAll($token,$where,$whereGroupOp='AND',$returnColumns='*',$orderColumns='1'){
            $_result = new TipoRecurso_Result_Rows();
        ...
        /**
         * Busca o registro do modelo TipoRecurso
         * Esse método é possível usar o parâmetro $data 
         * para fazer o Where, preenchendo a chave primária
         * Passando o parâmetro $where vazio
         *
         ...
         * @param ZendT_Service_Where[] $where
         * @param string $whereGroupOp
         * @return TipoRecurso_Result_Row
         */
        public function retrive($token,$data,$where,$whereGroupOp){
            $_result = new TipoRecurso_Result_Row();
