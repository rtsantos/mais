 ...
 */
class Auth_Model_AtRecurso_Crud_Mapper extends ZendT_Db_Mapper
{
    protected $_required = array('id','id_tipo_recurso','id_aplicacao','nome','hierarquia','status');
    protected $_model = 'Auth_Model_AtRecurso_Table';
    public static $table = 'mais.at_recurso';
    /**
     *
     * @var Auth_Model_AtRecurso_Mapper
     */
    ...
    public function getValueOld(){
        if (!$this->_dataOld instanceof Auth_Model_AtRecurso_Mapper){
            $this->_dataOld = new Auth_Model_AtRecurso_Mapper();
     ...
     *
     * @param string $value
     * @return Auth_Model_AtRecurso_Crud_Mapper
     */
