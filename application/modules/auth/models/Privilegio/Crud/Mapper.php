<?php
/**
 * Classe de mapeamento do registro da tabela at_privilegio
 */
class Auth_Model_Privilegio_Crud_Mapper extends ZendT_Db_Mapper
{
    protected $_required = array('id');
    protected $_model = 'Auth_Model_Privilegio_Table';
    public static $table = 'mais.at_privilegio';
    /**
     *
     * @var Auth_Model_Privilegio_Mapper
     */
    ...
    public function getValueOld(){
        if (!$this->_dataOld instanceof Auth_Model_Privilegio_Mapper){
            $this->_dataOld = new Auth_Model_Privilegio_Mapper();
     ...
     *
     * @param string $value
     * @return Auth_Model_Privilegio_Crud_Mapper
     */
