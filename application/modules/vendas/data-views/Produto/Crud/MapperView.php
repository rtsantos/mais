    ...
    */
    class Vendas_DataView_Produto_Crud_MapperView extends Vendas_Model_Produto_Mapper implements ZendT_Db_View
    {
        ...
        protected function _getSettingsDefault(){
           ...
           $profile['width'] = array('id'=>100,'codigo'=>200,'nome'=>200,'tipo'=>150,'apelido'=>200,'vlr_venda'=>150,'vlr_compra'=>150,'medida'=>150,'qtd_estoque'=>150,'id_cliente'=>120,'nome_cliente'=>200,'id_produto_resp'=>120,'codigo_produto_resp'=>200,'id_empresa'=>120,'nome_empresa'=>200);
           $profile['align'] = array('id'=>'left','codigo'=>'left','nome'=>'left','tipo'=>'center','apelido'=>'left','vlr_venda'=>'right','vlr_compra'=>'right','medida'=>'center','qtd_estoque'=>'right','id_cliente'=>'left','nome_cliente'=>'left','id_produto_resp'=>'left','codigo_produto_resp'=>'left','id_empresa'=>'left','nome_empresa'=>'left');
        ...
        protected function _loadColumns(){
            ...
            $this->_columns->add('vlr_venda', 'cv_produto', 'vlr_venda', $this->getModel()->getMapperName(), ZendT_Lib::translate('cv_produto.vlr_venda'),'Numeric','=');
            $this->_columns->add('vlr_compra', 'cv_produto', 'vlr_compra', $this->getModel()->getMapperName(), ZendT_Lib::translate('cv_produto.vlr_compra'),'Numeric','=');
            $this->_columns->add('medida', 'cv_produto', 'medida', $this->getModel()->getMapperName(), ZendT_Lib::translate('cv_produto.medida'),'String','=');
            $this->_columns->add('qtd_estoque', 'cv_produto', 'qtd_estoque', $this->getModel()->getMapperName(), ZendT_Lib::translate('cv_produto.qtd_estoque'),'Numeric','=');
