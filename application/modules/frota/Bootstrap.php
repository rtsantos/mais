<?php
    /**
     * Arquivo de inicialização do módulo Frota
     * 
     * @package Zend
     * @subpackage ZendT
     * @category Frota
     ...
     */
    class Frota_Bootstrap extends Zend_Application_Module_Bootstrap{
        /**
        ...
        protected function _initTranslate(){
            $translate = new Zend_Translate(
                    'array',
                    APPLICATION_PATH . '/modules/frota/languages/pt_BR.php',
                    'pt_BR'
            );

            Zend_Registry::set('translate_frota', $translate);
        }
