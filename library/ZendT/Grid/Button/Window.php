 ...
 * @category Button 
 */
class ZendT_Grid_Button_Window extends ZendT_Grid_Button implements ZendT_JS_Interface {
    /**
     *
     * @var type string
     */
    ...
    public function setParamFunction($functionJS){
        $this->_paramFunction = $functionJS;
        return $this;        
    }
        ...
        $clickFunction = '
            function(){
                jQuery.gridButtonWindow({
                    ...
                    modal: "' . $this->getModal() . '",
                    paramFunction: '.$this->getParamFunction().',
                    param: "' . $this->getParam() . '"
                });
            }
        ';
